...
**Dockerfile est un fichier de configuration d'un docker. Il est disponbile dans la branche docker du projet git.
...
Ce classement est sauvegardé et persite même lorsque l'on ferme le serveur.
